...
- narrate the prior week's RHR trend and HRV baseline breach, and
- combine load (ACWR) with recovery into a composite verdict, while degrading
  gracefully when recovery data is missing.

Catches regressions where the recovery integration (#503) is dropped from the
prompt.
"""
