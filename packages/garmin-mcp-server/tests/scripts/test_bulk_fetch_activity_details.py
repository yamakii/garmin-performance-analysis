...
class TestActivityDetailsFetcher:
    ...
    def test_scan_activities_finds_missing_files(self, temp_raw_dir):
        ...
        from garmin_mcp.scripts.bulk_fetch_activity_details import (
    ...
    @patch("garmin_mcp.scripts.bulk_fetch_activity_details.GarminIngestWorker")
...
class TestActivityDetailsFetcherIntegration:
    ...
    @patch("garmin_mcp.scripts.bulk_fetch_activity_details.GarminIngestWorker")
    @patch("garmin_mcp.scripts.bulk_fetch_activity_details.tqdm")
...
class TestCLI:
    ...
    @patch("garmin_mcp.scripts.bulk_fetch_activity_details.ActivityDetailsFetcher")
    def test_main_dry_run(self, mock_fetcher_class, capsys):
        """Test main function with --dry-run option."""
        import sys

        from garmin_mcp.scripts.bulk_fetch_activity_details import main
