...
Shared fixtures for database reader and inserter tests. The schema-initialised
DB fixtures (``initialized_db_path`` / ``reader_db_path`` / ``memory_db_path``)
live in the root ``tests/conftest.py`` (#1062).
"""
