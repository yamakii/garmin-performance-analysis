...
def test_cli_groups_cover_all_domains() -> None:
    ...
    # All 18 domains must be present (12 prior + strength added in #450 +
    # ingest added in #463 + workout added in #851 + hiking added in #921 +
    # plan added in #977 + gear added in #1209).
