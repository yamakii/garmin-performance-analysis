...
RUN_REPORT_TOOLS: list[ToolDef] = [
    ToolDef(
        ...
        description=(
            ...
            "{bpm, seconds_over, pct_over}; on a run with stride laps the "
            "ceiling row, seconds_over and pct_over cover the jog only; null "
            "when the day had no prescription), signals (per metric: today, "
