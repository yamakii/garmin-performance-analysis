...
RUN_REPORT_TOOLS: list[ToolDef] = [
    ToolDef(
        ...
        description=(
            ...
            "points with km_from/km_to and facts), recurrence (moment kinds "
            "that keep happening at the same km), phases (warmup/run/recovery/"
            "cooldown pace and HR), conditions (temp_c, humidity_pct, "
