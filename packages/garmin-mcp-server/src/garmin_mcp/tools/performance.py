...
PERFORMANCE_TOOLS: list[ToolDef] = [
    ...
    ToolDef(
        ...
        description=(
            ...
            "form evaluation scores, phase structure, and the prescription vs "
            "actual layer (that day's prescription, week_position, "
            "previous_same_type + vs_previous, morning_wellness and the "
            "deterministic prescription_verdict) in a single call. "
            "Auto-generates the form baseline for the activity's month (and "
            "prior month) if missing."
        ),
        params=ActivityIdParams,
