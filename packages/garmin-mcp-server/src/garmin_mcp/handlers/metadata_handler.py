"""Handler for metadata tools.

Thin adapter over the single-source registry
(``garmin_mcp.tools.metadata.METADATA_TOOLS``).
"""
...
from garmin_mcp.tools.metadata import METADATA_TOOLS_BY_NAME
from garmin_mcp.tools.registry import dispatch


class MetadataHandler:
    """Handles metadata-related tool calls via the registry."""

    _tool_names: set[str] = set(METADATA_TOOLS_BY_NAME)
