...
Usage:
    ...
    python tools/scripts/migrate_time_series_to_duckdb.py

    # Migrate specific activity IDs
    python tools/scripts/migrate_time_series_to_duckdb.py --activity-ids 12345 67890

    # Dry run (show what would be migrated)
    python tools/scripts/migrate_time_series_to_duckdb.py --dry-run

    # Verify integrity after migration
    python tools/scripts/migrate_time_series_to_duckdb.py --verify
