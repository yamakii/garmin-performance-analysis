...
Usage:
    ...
    uv run python tools/scripts/train_form_baselines_weekly.py --end-date 2025-10-06

    # Train for all October 2025 Mondays
    uv run python tools/scripts/train_form_baselines_weekly.py --end-date 2025-10-06
    uv run python tools/scripts/train_form_baselines_weekly.py --end-date 2025-10-13
    uv run python tools/scripts/train_form_baselines_weekly.py --end-date 2025-10-20
    uv run python tools/scripts/train_form_baselines_weekly.py --end-date 2025-10-27
"""
