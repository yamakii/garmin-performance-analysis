...
Usage:
    uv run python tools/scripts/train_form_baselines.py --condition flat_road
    uv run python tools/scripts/train_form_baselines.py --db-path data/database/garmin_performance.duckdb
