...
class TestFormEfficiencyInserter:
    ...
    def test_calculate_gct_evaluation(self):
        ...
        from tools.database.inserters.form_efficiency import _calculate_gct_evaluation
    ...
    def test_calculate_vo_evaluation(self):
        ...
        from tools.database.inserters.form_efficiency import _calculate_vo_evaluation
    ...
    def test_calculate_vr_evaluation(self):
        ...
        from tools.database.inserters.form_efficiency import _calculate_vr_evaluation
    ...
    def test_calculate_vo_trend(self, mocker):
        ...
        """
        from tools.database.inserters.form_efficiency import _calculate_vo_trend
