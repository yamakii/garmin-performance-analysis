...
class TestGetDataBaseDir:
    ...
    def test_get_data_base_dir_default(self) -> None:
        ...
        with patch.dict(os.environ, {}, clear=False):
            ...
            # Verify it's under the project root
            assert (data_dir.parent / "tools").exists()
            assert (data_dir.parent / "tests").exists()
...
class TestGetResultDir:
    ...
    def test_get_result_dir_default(self) -> None:
        ...
        with patch.dict(os.environ, {}, clear=False):
            ...
            # Verify it's under the project root
            assert (result_dir.parent / "tools").exists()
            assert (result_dir.parent / "tests").exists()
